...
if GPR:
    ...
    plt.plot(X_Test, Y_Test_pred_Conf[:,0],'.',markersize=1,alpha=0.5,color="yellow")  #lower bound confidence
    plt.plot(X_Test, Y_Test_pred_Conf[:,1],'.',markersize=1,alpha=0.5,color="yellow")  #upper bound confidence
...
if ANN:
    ...
    model.add(layers.Dense(100, input_dim=1, activation='sigmoid'))
    ...
    if Extrapolation:
        ...
        plt.plot(X_ext,Y_ext, 'y.', label='Extrapolated True Data')
