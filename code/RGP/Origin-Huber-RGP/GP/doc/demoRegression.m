...
disp(' ');
disp('nlml = gpr(hyp, @infExact, meanfunc, covfunc, likfunc, x, y)');
nlml = gpr(hyp, @infExact, meanfunc, covfunc, likfunc, x, y)
disp(' ')

disp('z = linspace(-1.9, 1.9, 101)'';');
z = linspace(-1.9, 1.9, 101)';
disp('[m s2] = gpr(hyp, @infExact, meanfunc, covfunc, likfunc, x, y, z);');
[m s2] = gpr(hyp, @infExact, meanfunc, covfunc, likfunc, x, y, z);
...
disp('exp(hyp2.lik)');
exp(hyp2.lik)
disp('nlml2 = gpr(hyp2, @infExact, [], covfunc, likfunc, x, y)');
nlml2 = gpr(hyp2, @infExact, [], covfunc, likfunc, x, y)
disp('[m s2] = gpr(hyp2, @infExact, [], covfunc, likfunc, x, y, z);');
[m s2] = gpr(hyp2, @infExact, [], covfunc, likfunc, x, y, z);
...
disp('[mF s2F] = gpr(hyp, @infFITC, meanfunc, covfuncF, likfunc, x, y, z);')
[mF s2F] = gpr(hyp, @infFITC, meanfunc, covfuncF, likfunc, x, y, z);
