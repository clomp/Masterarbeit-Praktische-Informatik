function [varargout] = gpr(hyp, inf, mean, cov, lik, x, y, xs, ys)
...
%
%   training: [nlZ dnlZ          ] = gpr(hyp, inf, mean, cov, lik, x, y);
% prediction: [ymu ys2 fmu fs2   ] = gpr(hyp, inf, mean, cov, lik, x, y, xs);
%         or: [ymu ys2 fmu fs2 lp] = gpr(hyp, inf, mean, cov, lik, x, y, xs, ys);
%
% where:
%
